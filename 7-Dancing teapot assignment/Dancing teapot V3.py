...
def draw():
    ...
    drawteapot(1.2, shift, 3.8, teapotangle)
    glLineWidth(40)
    glBegin(GL_LINES)
    glColor3d(1, 0, 1)
    glVertex3f(1.2, 0, 3.8)
    glVertex3f(1.2, shift, 3.8)
    glEnd()

    # TODO third teapot and stick
    drawteapot(-3.2, shift, 2.3, teapotangle)
    glLineWidth(40)
    glBegin(GL_LINES)
    glColor3d(1, 0, 1)
    glVertex3f(-3.2, 0, 2.3)
    glVertex3f(-3.2, shift, 2.3)
    glEnd()
